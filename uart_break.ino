...
/* Serial on/off Break
 // Работает плохо. 
 // 1. В момент включения uart виду короткий лишний импульс
...
// Отправка break + посылка
 ...
 delayMicroseconds(100);                                          // добавляем ожидания, иначе скорость переключится раньше отправки. С задержкой 100us на d1-mini я получил идеальный сигнал, break = 520us? отправлял 0x00
